...
export const proofSchema = <Id>(id: z.ZodSchema<Id>): z.ZodSchema<Proof<Id>> => z.object({
  theorems: z.array(id),
...
export const traitSchema = <Id>(id: z.ZodSchema<Id>): z.ZodSchema<Trait<Id>> => z.intersection(
  z.object({
    space: id,
    property: id,
    value: z.boolean(),
